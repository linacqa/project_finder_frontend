...
export default function PrivacyPolicyPage() {
	return (
		<TTNewContainer>
			...
			<p>NB: privaatsuspoliitikat veel täiendatakse</p>
			<p>ProFin jaoks on oluline Teie privaatsus ja järgida kõiki kehtivaid seadusi ja määrusi mis tahes isikuandmete kohta, mida võime Teie kohta koguda, kui külastate meie veebilehte <a href="https://profin.itcollege.ee">profin.itcollege.ee</a>. Meie veebisaiti kasutades nõustute, et kogume ja kasutame Teie andmeid vastavalt käesolevale privaatsuspoliitikale.</p>
			...
			{/* <p>Teie andmete töötleja on ... </p> */}

			<p>e-post: dmitri.mironov@taltech.ee </p>
			...
			<ul>
				...
				<li>Kui registreerute meie veebilehel</li>
			...
			<ul>
				...
				<li>Uni-ID</li>
				<li>Matriklinumber</li>
			</ul>
			{/* <h4>Logifailid</h4>
			<p>Meie veebileht <a href="https://profin.itcollege.ee">profin.itcollege.ee</a> salvestab oma külastajate kohta logifaile. Kogutava teabe hulka võib kuuluda:</p>
			<ul>
			...
			<h4>Küpsised</h4>
			<p>Nagu enamus veebilehti, kasutab ka <a href="https://profin.itcollege.ee">profin.itcollege.ee</a> "küpsiseid". Küpsis on sisuliselt tekstifail, mis salvestatakse veebisaidi külastamisel kasutaja seadmesse. Küpsiste abil määratakse ja salvestatakse eelistused, regionaalsed sätted, teenuste kasutamise valikud jpm.</p>
			...
			<p><b>Vajalikud küpsised.</b> Sessiooniküpsised, mille eesmärgiks on võimaldada Teile meie veebisaidil pakutavate teenuste kasutamist. Need küpsised aitavad kasutajaid autentida ja vältida kasutajakontode pahatahtlikku kasutamist. Ilma nende küpsisteta ei saa me Teile soovitud teenuseid pakkuda.</p>
			<p><b>Teavitusküpsised.</b> Need küpsised tuvastavad, kas kasutajad on veebisaidil küpsiste kasutamist aktsepteerinud.</p>
			<p><b>Funktsionaalsuse küpsised.</b> Need küpsised võimaldavad Teie brauseril meeles pidada valikuid, mida teete veebisaidi kasutamisel, näiteks Teie sisselogimisandmete või keele-eelistuste salvestamine. Nende küpsiste eesmärk on pakkuda Teile personaalsemat kogemust ja vältida eelistuste uuesti sisestamist.</p>
			<h3>Kuidas me andmeid kasutame</h3>
			<p>Kogutud informatsiooni võime kasutada erinevatel eesmärkidel, sealhulgas:</p>
			<ul>
				<li>Teie profiili loomiseks ja kuvamiseks. Kogu registreerimisel sisestatud informatsioon on nähtav teistele kasutajatele, välja arvatud Uni-ID ja matriklinumber, mis on nähtavad ainult administraatoritele, projektide juhendajatele ja üliõpilastele. Tavakasutajad Uni-ID ja matriklinumbit ei näe.</li>
				...
				<li>Teie tuvastamiseks e-posti või telefoni teel</li>
				...
				<li>Et parandada teenuste funktsionaalsust</li>


				<li>Meievaheliste interaktsioonide lihtsustamiseks ja kiirendamiseks, kui võtate meiega ühendust</li>
				<li>Muudel eesmärkidel. Näiteks andmete analüüsimiseks.</li>
			</ul>
			<h3>Millistel juhtudel on võimalik, et jagame Teie andmeid</h3>
			<ul>
				<li>
					Võime jagada või edastada Teie isikuandmeid seoses meie süsteemi omanike vahetusega. Teavitame Teid Teie isikuandmete edastamisest ja sellest, kui neile hakkavad kehtima mõne teise privaatsuspoliitika sätted.
				</li>
			...
			<p>Säilitame Teie isikuandmeid ainult seni, kuni see on vajalik käesolevas privaatsuspoliitikas sätestatud eesmärkidel. Säilitame ja kasutame Teie isikuandmeid ulatuses, mis on vajalik meie juriidiliste kohustuste täitmiseks (näiteks kui peame Teie andmeid säilitama kehtivate seaduste järgimiseks), vaidluste lahendamiseks ning meie juriidiliste lepingute ja eeskirjade jõustamiseks.</p>
				{/* <p>Säilitame logifaile ka siseanalüüsi eesmärgil. Logifaile säilitatakse tavaliselt lühemat aega, välja arvatud juhul, kui neid andmeid kasutatakse turvalisuse tugevdamiseks või meie teenuse funktsionaalsuse parandamiseks või kui me oleme seadusega kohustatud neid andmeid pikemaks ajaks säilitama.</p> */}
			...
			<p>Vajadusel on meil õigus teha käesolevale privaatsuspoliitika dokumendile muudatusi. Privaatsuspoliitika uuenemise järel muudame me selle allosas paiknevat dokumendi värskendamise kuupäeva. Kui külastate ja kasutate meie veebilehte ka pärast privaatsuspoliitika uuendamist, käsitleme me seda kui Teie vaikivat nõusolekut muudatustega.</p><br/>
			<p>Viimati muudetud 06/05/2026</p><br/>
		</TTNewContainer>
		);
}
